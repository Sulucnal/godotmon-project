...
func show_message(message : String, talker_name : String = "", talker_image_path : String = "", instantaneous : bool = false) -> void:
	...
	#dialog_box.show()
	dialog_box.handle_message_display(instantaneous)
